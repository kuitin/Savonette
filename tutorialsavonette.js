 ...
 * -----
 *
 * tutorialsavonette.js
 *
 * TutorialSavonette user interface script
 * 
...
function (dojo, declare) {
    return declare("bgagame.tutorialsavonette", ebg.core.gamegui, {
        constructor: function(){
            console.log('tutorialsavonette constructor');
        ...
        //    this.playerHand.addToStockWithId( this.getCardUniqueId( 3, 5 ), 43 );   
        },
      ...
      onPlayerHandSelectionChanged : function() {
        ...
        /*
            ...
            Note: game notification names correspond to "notifyAllPlayers" and "notifyPlayer" calls in
                  your tutorialsavonette.game.php file.
